...
public final class ForceValue extends ValueBase<Force,ForceValue>
{
    ...
    ====** Constructors **=====================================================
        \*--------------*/
    /**
     *  Creates a new {@code ForceValue} instance.
     *
     *  @param  dimension   The dimension.
     *  @param  value   The value.
     */
    public ForceValue( final Force dimension, final BigDecimal value )
    {
     ...
     */
    public ForceValue( final Force dimension, final String value ) throws NumberFormatException
    {
        //---* Daddy's performing the null check ... *-------------------------
        //noinspection unchecked
        super( dimension, value, DEFAULT_VALIDATOR );
     ...
     *  @param  value   The value.
     */
    public <N extends Number> ForceValue( final Force dimension, final N value )
    {
        //---* Daddy's performing the null check ... *-------------------------
        //noinspection unchecked
        super( dimension, value, DEFAULT_VALIDATOR );
