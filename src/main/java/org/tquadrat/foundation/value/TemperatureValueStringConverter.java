 ...
 *  @version $Id: TemperatureValueStringConverter.java 1195 2026-04-15 21:33:40Z tquadrat $
 *  @since 0.1.0
 *
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: TemperatureValueStringConverter.java 1195 2026-04-15 21:33:40Z tquadrat $" )
...
public final class TemperatureValueStringConverter extends DimensionedValueStringConverter<Temperature,TemperatureValue>
{
     ...
     */
    @Override
    protected Temperature unitFromSymbol( final String symbol )
    {
        return Temperature.forUnit( symbol );
    }   //  dimensionFromUnit()
}
